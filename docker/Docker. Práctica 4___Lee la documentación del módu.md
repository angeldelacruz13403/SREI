...
Este ejemplo despliega una instancia de WordPress con una base de datos MariaDB utilizando Docker Compose, definiendo volúmenes para la persistencia de datos y una red para la comunicación.
